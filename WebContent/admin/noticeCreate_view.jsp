...
%>
		<form name="modify" method="POST" action="ccr?cmd=noticeManager&mode=createFinish">
			<table class="res">
				<thead>
					<tr><th>제목</th><td><input type="text" name="title" value="" size="200" /></td></tr>
					<tr><th>내용</th><td><textarea name="description" cols="120" rows="15"></textarea></td></tr>
				</thead>
				<tr>
