...
<%
	...
	ConcurrentHashMap<String, ChargeHistoryPeriod> list = (ConcurrentHashMap<String, ChargeHistoryPeriod>) request
			.getAttribute("list");
...
<div id="stylized" >
	...
	<br />
	<form name="search" method=POST action="./ccr?cmd=driveDetail&mode=month">
	...
	%>
			...
			<%
			ChargeHistoryPeriod ch = list.get(date.substring(0,7));
