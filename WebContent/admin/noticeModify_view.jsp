...
%>
		<form name="modify" method="POST" action="ccr?cmd=noticeManager&mode=modify">
		<input type="hidden" name="no" value="<%=no %>" />
			<table class="res">
				<thead>
					<tr><th>NO</th><td><input type="hidden" value="<%=no %>"/ ><%=no %></td></tr>
					<tr><th>등록일</th><td><%=reg_date %></td></tr>
					<tr><th>제목</th><td><input type="text" name="title" value="<%=title %>" size="200" /></td></tr>
					<tr><th>내용</th><td><textarea name="description" cols="120" rows="15"><%=description %></textarea></td></tr>
				</thead>
				<tr>
